...
class OnboardingRepositoryImpl @Inject constructor(
    ...
    override suspend fun saveOnboardingDisplayed() {
        dataStorePreferences.putPreference(DataStorePreferencesConstants.ONBOARDING_DISPLAYED_KEY, true)
    }

    override suspend fun getOnboardingDisplayed() =
        dataStorePreferences.getPreference(DataStorePreferencesConstants.ONBOARDING_DISPLAYED_KEY, false)
}